...
try {
	...
	$stmt = $dbcon->prepare("SELECT gid, objectid_1, nama_di, desa, kecamatan, eto_sept, eto_okt, eto_nov, eto_des, eto_jan, eto_feb, eto_mar, eto_apr, eto_mei, eto_jun, eto_jul, eto_ags, public.ST_AsGeoJSON(public.ST_Transform((geom),4326),6) AS geojson FROM pl_mt_eto");
	if($stmt->execute()){
		$id_count = 0;
