...
try {
	...
	$stmt = $dbcon->prepare("SELECT gid, objectid_1, nama_di, desa, kecamatan, che_sept, che_okt, che_nov, che_des, che_jan, che_feb, che_mar, che_apr, che_mei, che_jun, che_jul, che_ags, public.ST_AsGeoJSON(public.ST_Transform((geom),4326),6) AS geojson FROM pl_mt_che");
	if($stmt->execute()){
		$id_count = 0;
